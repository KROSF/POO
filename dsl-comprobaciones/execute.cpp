...
void execute::classWithListInitializerConstructor(const MatchFinder::MatchResult &Result)
{
	...
	if (existClass(foundClassWithListInitializerConstructor) && existConstructor(foundListInitializerConstructor) && foundListInitializerConstructor->getNumCtorInitializers() != 0)
	{
