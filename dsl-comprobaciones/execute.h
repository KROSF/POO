...
class execute : public MatchFinder::MatchCallback,
                public ASTConsumer,
 ...
 public:
  void setDefaultConstructors(string className, bool exist,
 ...
 public:
  void setCopyConstructors(string className, bool exist,
                           string notFoundMessage);
 ...
 public:
  void setMoveConstructors(string className, bool exist,
                           string notFoundMessage);
 ...
 public:
  void setInitializers(string className, vector<string> parameters,
                       vector<string> inits, string message);

 private:
  void classWithListInitializerConstructor(
 ...
 public:
  void setConstructors(string className, unsigned int constructors,
 ...
 public:
  void setExplicitSpecifiedConstructors(string className,
                                        vector<string> parameters,
                                        string message);
 ...
 public:
  void setMembers(string className, string memberName, string constant,
 ...
 public:
  void setStaticVariables(string className, string variableName,
 ...
 public:
  void setMembersAccessLevel(string className, string memberName, string level,
                             string message);

 private:
  void classWithVariableMembersAccessLevel(
      const MatchFinder::MatchResult &Result);
 ...
 public:
  void setMethodsWithName(string methodName, string className,
 ...
 public:
  void setMethodsWithDefaultArg(string methodName, string className,
                                vector<string> params, vector<string> defaults,
                                string constant, string message);
 ...
 private:
  ...
  // ----------------------- METHODS WITH REFERENCED
  // VARIABLE---------------------

 public:
  void setMethodsWithReferencedVariable(string methodName, string className,
                                        vector<string> params, string constant,
                                        string memberVariable, string message);
 ...
 public:
  void setMethodsWithReferencedMethod(string mainMethodName,
                                      vector<string> mainMethodParams,
                                      string mainClassName, string mainConstant,
                                      string usedMethodName,
                                      vector<string> usedMethodParams,
                                      string usedClasName, string usedConstant,
                                      string message);
 ...
 public:
  void setNoExceptMethods(string methodName, vector<string> params,
                          string className, string constant, string message);
 ...
 public:
  void setInlineMethods(string methodName, vector<string> params,
                        string className, string constant, string message);
 ...
 public:
  void setDefaultArgumentsInMethod(string methodName, vector<string> params,
                                   string className, string constant,
                                   unsigned int numDefaultArgs,
                                   vector<string> defaultArgs, string message);
 ...
 public:
  void setDeletedMethods(string methodName, string className,
                         vector<string> params, string constant,
                         string message);
 ...
 public:
  void setDefaultedMethods(string methodName, string className,
                           vector<string> params, string constant,
                           string message);
 ...
 private:
  ...
  // ----------------------- METHODS VIRTUAL ---------------------
 public:
  void setVirtualMethods(string methodName, string className,
                         vector<string> params, string constant,
                         string message);
 ...
 public:
  void setFunctionsWithReferencedFunction(string mainFunctionName,
                                          vector<string> mainFunctionParameters,
                                          string usedFuncionName,
                                          vector<string> usedFunctionParameters,
                                          string message);
 ...
 public:
  void setMethodsWithReferencedFunction(
      string mainMethodName, vector<string> mainMethodParameters,
      string mainClassName, string mainConstant, string usedFuncionName,
      vector<string> usedFunctionParameters, string message);
 ...
 public:
  void setFunctionsWithReferencedMethod(string mainFunctionName,
                                        vector<string> mainFunctionParameters,
                                        string usedMethodName,
                                        vector<string> usedMethodParameters,
                                        string usedConstant, string usedClass,
                                        string message);
 ...
 public:
  void setFunctionsWithName(string functionName, vector<string> params,
                            string message);
 ...
 public:
  void setInvocationsFromHeader(string functionNames, string headerName,
                                bool exist, string message);
 ...
 private:
  ...
  // --------------------- FILE INCLUDE HEADER ------------------
 public:
  void setFileIncludeHeader(vector<string> fileName, string headerName,
                            string message);
 ...
 public:
  void setFriendFunction(string functionName, string className,
 ...
 private:
  ...
  //------------------------ DYNAMIC CAST --------------------------
 public:
  void setDynamicCast(string methodName, vector<string> parameters,
                      string constant, string className, string originType,
                      string dstType, string message);
