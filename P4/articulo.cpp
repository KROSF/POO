...
Articulo::Articulo(Autores autores,
                   const Cadena &ref,
                   const Cadena &title,
                   const Fecha &publi, double precio) : autores_(autores), cod_ref_(ref), titulo_(title),
...
Libro::Libro(Autores autores,
             ...
             const Cadena &title,
             const Fecha &publi,
             double precio, unsigned paginas, unsigned stock) : ArticuloAlmacenable(autores, ref, title, publi, precio, stock),
                                                                n_pag_(paginas) {}
...
LibroDigital::LibroDigital(Autores autores,
                           const Cadena &ref,
                           const Cadena &title,
                           const Fecha &publi, double precio, const Fecha &exp) : Articulo(autores, ref, title, publi, precio), f_expir_(exp) {}
...
Cederron::Cederron(Autores autores, const Cadena &ref,
                   const Cadena &title,
                   const Fecha &publi,
                   double precio, unsigned tam, unsigned stock) : ArticuloAlmacenable(autores, ref, title, publi, precio, stock),
                                                                  tam_(tam) {}
