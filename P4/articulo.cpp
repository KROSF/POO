...
/* Articulo */
Articulo::Articulo(Autores autores, const Cadena &ref, const Cadena &title,
...
std::ostream &operator<<(std::ostream &os, const Articulo &artcl) noexcept {
  os << "[" << artcl.referencia() << "] \"" << artcl.titulo() << "\", de ";
...
ArticuloAlmacenable::ArticuloAlmacenable(Autores autores, const Cadena &ref,
                                         const Cadena &title,
                                         const Fecha &publi, double precio,
                                         unsigned stock)
...
Libro::Libro(Autores autores, const Cadena &ref, const Cadena &title,
             const Fecha &publi, double precio, unsigned paginas,
             unsigned stock)
...
LibroDigital::LibroDigital(Autores autores, const Cadena &ref,
                           const Cadena &title, const Fecha &publi,
                           double precio, const Fecha &exp)
    : Articulo(autores, ref, title, publi, precio), f_expir_(exp) {}

/* Cederron */

Cederron::Cederron(Autores autores, const Cadena &ref, const Cadena &title,
                   const Fecha &publi, double precio, unsigned tam,
                   unsigned stock)
    : ArticuloAlmacenable(autores, ref, title, publi, precio, stock),
      tam_(tam) {}
